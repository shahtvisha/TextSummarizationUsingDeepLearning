...
# List document titles in the selectbox
document_titles = list(data.keys())
selected_document = st.selectbox("Select a Document", document_titles)
...
# Access and display the selected document's requirements
